...
public class BlockBeryliumOre extends Mar21Block
{
    public BlockBeryliumOre(int id, Material par2Material, CreativeTabs par3CreativeTabs)
    {
    ...
    {
        return ModCore.berylium_crystal.itemID;
    }
