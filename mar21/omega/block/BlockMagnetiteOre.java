...
public class BlockMagnetiteOre extends Mar21Block
{
    public BlockMagnetiteOre(int id, Material par2Material, CreativeTabs par3CreativeTabs)
    {
    ...
    {
        return ModCore.magnetite_crystal.itemID;
    }
