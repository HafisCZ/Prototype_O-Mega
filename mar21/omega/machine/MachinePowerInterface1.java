...
public class MachinePowerInterface1 extends Block{
	
	public MachinePowerInterface1(int id, Material par2Material,
    ...
    public void onBlockAdded(World par1World, int par2, int par3, int par4)
    {
        ...
        par1World.scheduleBlockUpdate(par2, par3, par4, ModCore.machine_power_interface_act.blockID, 1);
        /**
    ...
    {
    	world.setBlock(x, y ,z, ModCore.machine_power_interface.blockID);
    	return true;
    	/**
